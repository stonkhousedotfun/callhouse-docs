...
{% hint style="warning" %}
**Before you deposit:** Premium is paid only if a buyer fills. Assignment can take the collateral at the strike. Stock Tokens are debt securities, issued by Robinhood Assets (Jersey) Limited. Callhouse is not available to US persons. The contracts are unaudited. Read [Risks](../product/risks.md) first.
{% endhint %}
