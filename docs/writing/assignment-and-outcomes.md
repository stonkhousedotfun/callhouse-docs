...
**Illustrative covered call.** You write one share at a 200 USDG strike and receive a 2 USDG premium before any book fee. At a 220 USDG final price, the long's gross intrinsic value is about 20 USDG, paid from the locked Stock Token. The short receives the remaining Stock Token value, about 200 USDG, rather than the original whole share. In proposed v7, the writer paid rent in Stock Tokens when those units were minted; the planned primary premium fee is 0%. Price, rounding, rent and other fees can change this illustrative result.
