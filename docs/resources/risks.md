...
{% hint style="danger" %}
The live v2 deployment's hot admin key has no timelock. The maker-vault outflow cap does not restrict admin actions. Contract and issuer controls can still delay payouts or cause losses.
{% endhint %}
