...
**At expiry.** The settlement oracle prices the final 30 minutes before 16:00 New York on the expiry date. It uses the market's configured sources; a single-source result waits through a candidate delay. Once the price is final, anyone can settle the series and then redeem a holder's position unless that holder has disabled third-party redemption. These calls require transactions. A production cranker is online and has created NVDA series, but its automated settlement and redemption have not yet been proven; watch the 18 September 2026 20:00 UTC expiry and the on-chain state. A call can expire with no buyer payout; the buyer's maximum loss on the option is the premium and taker fee paid, with network gas extra.
