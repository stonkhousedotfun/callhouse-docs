...
{% hint style="warning" %}
**The Callhouse vault is not deployed yet.** There is no Callhouse vault address, no library address, no Callhouse clearinghouse address, no admin address and no fee recipient address. They will be published on this page at launch.
...
cast call $VAULT "clear()(address)"          --rpc-url $RH_RPC   # the Callhouse clearinghouse listed above
